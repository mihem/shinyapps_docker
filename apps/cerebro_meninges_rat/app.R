...
custom_welcome_message <- '<h2 style="text-align: center; margin-top: 0px"><strong>Single-cell atlas of the meninges from rat </strong></h3>
<br>
  <p style="margin-left: 10px;">This data set belongs to the publication <a href = "https://doi.org/10.1038/s41593-021-00880-y"> Single-cell profiling of CNS border compartment leukocytes reveals that B cells and their progenitors reside in non-diseased meninges </a> by Schafflick et al., <em> Nature Neuroscience </em> 2021. <br> It contains single cell RNA-sequencing data of tissue-resident leukocytes from healthy rats. For more details please refer to <a href = "https://doi.org/10.1038/s41593-021-00880-y"> our publication </a>.<br> The sequencing raw data can be found at <a href =  "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE165153"> GEO GSE165153</a>.<br> Please contact us at <a href = "https://www.mheming.com"> mheming.com </a> if you have any questions.</p>
<br>'
