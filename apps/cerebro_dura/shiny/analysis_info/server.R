...
output[["data_set_info_general"]] <- renderText({
  ...
  general_info <- paste0(
    ...
    "<ul>",
      ...
      experiment$date_of_analysis,
      "<li><b>Date of export:</b> ",
      experiment$date_of_export,
  ...
  if (!is.null(technical_info_raw)) {
    info_R_raw <- technical_info_raw$R
    if (!is.null(info_R_raw)) {
