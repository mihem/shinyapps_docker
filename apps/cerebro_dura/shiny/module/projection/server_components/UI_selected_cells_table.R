...
##----------------------------------------------------------------------------##
output[["selected_cells_table_UI"]] <- renderUI({
  ...
  fluidRow(
    cerebroBox(
      title = tagList(
        ...
        cerebroInfoButton(ns("details_selected_cells_table_info"))
      ),
      tagList(
        shinyWidgets::materialSwitch(
          inputId = ns("details_selected_cells_table_number_formatting"),
        ...
        shinyWidgets::materialSwitch(
          inputId = ns("details_selected_cells_table_color_highlighting"),
          label = "Highlight values with colors:",
          value = TRUE,
          status = "primary",
          inline = TRUE
        ),
        DT::dataTableOutput(ns("details_selected_cells_table"))
      )
    )
  )
})
...
##----------------------------------------------------------------------------##
observeEvent(input[["details_selected_cells_table_info"]], {
  showModal(
    modalDialog(
